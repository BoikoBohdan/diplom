  ...
  render() {
    return (
      <div className='footer__tool-bar'>
        <span className='table__pows-per-page--text'>Rows per page:  </span>
        <Select
        ...
        <div className='table__curent-page-wrapper'>
          <span className='table__from-to-curent'>
            {this.props.page == 1 ? (this.props.page) * this.props.page : this.props.perPage}-{this.props.page * this.props.perPage < this.props.total ? this.props.page * this.props.perPage : this.props.total} of {this.props.total}
          </span>
          {this.props.page !== 1 &&
            <>
          ...
          {this.props.page < (this.props.total / this.props.perPage) ?
            ...
            :
            <div className="table__change-page-empty"></div>
          }
        </div>
      </div>
    );
